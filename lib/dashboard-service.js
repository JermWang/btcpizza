...
const DEFAULT_NVDAX_MINT = "Xsc9qvGR1efVDFGLrVsmkzv3qi45LTBjeUKSPmx9qEh";
...
function publicConfig(env = process.env) {
  ...
  const nvdaxMint = env.REWARD_MINT || env.PUBLIC_NVDAX_MINT || DEFAULT_NVDAX_MINT;
...
function publicEpochRecord(epoch) {
  ...
  return {
    ...
    rewardPoolNvdax: epoch.rewardPoolNvdax ?? 0,
